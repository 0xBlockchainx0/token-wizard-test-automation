...
/////////////////////////////////////////////////////////////////////////
    ...
    test.before(async function () {
        const startTime = '2030-02-01 05:16'
        console.log(startTime)
        const array = startTime.split(' ')
        console.log(array[0])
        console.log(array[1])
        const date = array[0].replace(/-/g, "/");
        ...
        console.log(crowdsaleMintedSimple.name)
...
///////////////////////// UI TESTS /////////////////////////////////////
    describe('Welcome page', async function () {
        ...
        test.it.skip('Warning present if user logged out from wallet',
            async function () {
    ...
    describe('Publish page', async function () {
        ...
        describe('Check alert, buttons', async function () {
            ...
            test.it('Clicking button \'Continue\' opens Crowdsale page ',
                async function () {
                    await publishPage.clickButtonContinue()
                    return await assert.equal(true, true, 'Crowdsale page didn\'t open ');
                });
        })
        describe('Contribution page:', async function () {
            test.it.skip('Should be alert if invalid proxyID in address bar',
                async function () {
