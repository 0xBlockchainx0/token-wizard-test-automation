...
/////////////////////////////////////////////////////////////////////////
    ...
    test.before(async function () {
        ...
        tierPage = new TierPage(driver, e2eWhitelist.tiers[0]);
    ...
    test.it("Invest page: Owner's balance has correct value (totalSupply-supply) ",
        async function () {
            ...
            let owner = Owner;
            assert.equal(await owner.openContributionPage(e2eWhitelist), true, 'Investor can not open Contribution page');
